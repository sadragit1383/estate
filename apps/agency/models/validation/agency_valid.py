...
# تابعی که validator دلخواه را می‌سازد
def create_image_validator(max_size_kb, allowed_extensions):
    return lambda value: simple_image_validator(value, max_size_kb, allowed_extensions)