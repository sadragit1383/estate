...
from .views.location_view import UserLocationCreateView,CountryListView, ProvinceListView, CityListView, AreaListView
...
urlpatterns = [
    ...
    path('UserLocationCreateView', UserLocationCreateView.as_view()),
]
